...
```{ojs load results db}
// ojs_define(ss1=arrow::read_parquet("sourcesink1.parquet"))
// ojs_define(ss2=arrow::read_parquet("sourcesink2.parquet"))
// ojs_define(ss3=arrow::read_parquet("sourcesink3.parquet"))

// import { DuckDBClient } from '@rlesur/quarto-duckdb'
// stdlibDev = await import("https://esm.sh/@observablehq/stdlib");

resdb = DuckDBClient.of({
  sourcesink1: FileAttachment("sourcesink1.parquet"),
  sourcesink2: FileAttachment("sourcesink3.parquet"),
...
// resdb.query(`SELECT * FROM sourcesink1`)
```
...
// data_f = data_hm.filter(d => parseFloat(d.name.split("_")[1]))

// data_hm.a
// Plot.plot({
//   width: 1200,
//   facet: {data: data_f, x: "L", marginRight: 90},
//   marks: [
//     Plot.cell(data_f, {
//       x: "season",
//       y: "number_in_season",
